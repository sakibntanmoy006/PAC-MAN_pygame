...
NO_WX= 1 # if set,No user name will be asked
USER_NAME=os.getlogin() # the default user name
...
SCORE_XOFFSET=50 # pixels from left
SCORE_YOFFSET=34 # pixels from bottom
...
pygame.display.set_caption("PAC-MAN: The Game")
